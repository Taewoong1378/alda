...
export const BottomNavbar = () => {
  ...
  return (
    <div className='border-t-grey-6 border-t-1 fixed bottom-0 right-1/2 z-[200] flex h-[100px] w-full max-w-[498px] translate-x-1/2 justify-evenly bg-[rgba(0,0,0,0.09)]'>
